# Step 4: Start Your FluxNode

Congratulations! You’ve successfully installed and configured your FluxNode.\
The final step is to **start your node** so it can begin operating on the Flux network.

Starting your FluxNode will:

* Activate your node on the blockchain.
* Begin blockchain and FluxOS services.
* Allow the network to recognize and verify your node’s collateral transaction.
