...
_These are part of the wider Flux Suite but are **not** covered in detail in this GitBook._

#### Zelcore Wallet

An all-in-one, non-custodial desktop & mobile wallet for FLUX and dozens of other chains.

* Manage FLUX alongside Bitcoin, Ethereum, and dozens more.
* Instantly exchange assets and stake FLUX for rewards.
* Operate and monitor your FluxNodes directly within the wallet.
* [Learn more →](https://zelcore.io/)

#### SSP Wallet

Secure, Simple, Powerful browser-extension wallet designed for ease of use and robust security.

* BIP48-based dual-signature transactions
* Operate and monitor your FluxNodes directly within the extension
* Streamlined interface for both new and experienced Web3 users
* [Learn more →](https://sspwallet.io/)

#### FluxAI

A privacy-focused AI platform leveraging Flux's global GPU network of FluxEdge.

* **FluxGPT**, **FluxONE**, **FluxINTEL**
* Scales to enterprise workloads while ensuring data sovereignty.
* [Learn more →](https://ai.runonflux.com/)

#### Flux Exchange&#x20;

A multi-chain, no-KYC decentralized exchange that aggregates liquidity for seamless, trustless swaps.

* Trustless cross-chain swaps
* No KYC or account registration required
* Supports WalletConnect and popular Web3 wallets
* Aggregates liquidity from multiple chains and protocols
* [Learn more →](https://fusionx.runonflux.com/)
