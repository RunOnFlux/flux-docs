...
* **[General](./general)** - App name, Docker image, and basic settings
* **[Geolocation](./geolocation)** - Geographic deployment preferences
* **[Priority Nodes](./priority-nodes)** - Preferred node selection
* **[Components](./components)** - Resource allocation and ports
* **[Review](./review)** - Final review and deployment

After deployment, you can optionally configure a **[Custom Domain](../custom-domain-setup)**.
