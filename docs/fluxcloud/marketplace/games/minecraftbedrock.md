...
* Visit **[minecraft.runonflux.com](https://minecraft.runonflux.com)** — the dedicated Minecraft Bedrock hosting portal — and sign in or create an account. (Going through [cloud.runonflux.com](https://cloud.runonflux.com) works too: clicking the Minecraft Bedrock tile in the Marketplace redirects you there automatically.)
