...
> **Applications → Management → Manage App → Information**

Open the **Management** tab in the **Applications** menu, select an application from **My Active Apps**, click **Manage**, and open the **Information** tab.
