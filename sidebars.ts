      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            'fluxcloud/register-new-app/general',
            'fluxcloud/register-new-app/geolocation',
            'fluxcloud/register-new-app/priority-nodes',
            'fluxcloud/register-new-app/components',
            'fluxcloud/register-new-app/review',
